...
ENT.PrintName			= "[WAC]F-4E Phantom II (Napalm)"
...
ENT.Seats = {
	{
		...
		weapons={"M61 Vulcan", "Mk 77 Napalm", "AIM-9 Missiles", "AIM-7 Missiles"},
	},
	{
		pos=Vector(82, 0, 86),
		exit=Vector(82,100,40),
		weapons={"Mk 77 Napalm", "AIM-9 Missiles","AIM-7 Missiles"}
	},
}

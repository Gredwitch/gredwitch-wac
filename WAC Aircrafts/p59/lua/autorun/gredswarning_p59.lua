...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(232152689) and steamworks.IsSubscribed(232152689)
		...
		if !RequiredContent then
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=232152689.html')
		end
	end
end)
...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(823635967) and steamworks.IsSubscribed(823635967)
		...
		if !RequiredContent then
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=823635967.html')
		end
	end
end)
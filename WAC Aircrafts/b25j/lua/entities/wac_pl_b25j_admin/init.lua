...
function ENT:PhysicsUpdate(ph)
	...
	if IsValid(self.rotorModel) then self.rotorModel:SetSkin(self:GetSkin()) end
	if IsValid(self.OtherRotorModel) then self.OtherRotorModel:SetSkin(self:GetSkin()) end

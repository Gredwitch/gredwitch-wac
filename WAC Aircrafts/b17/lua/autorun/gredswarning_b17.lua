...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(346171700) and steamworks.IsSubscribed(346171700)
		...
		if !RequiredContent then
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=346171700.html')
		end
	end
end)
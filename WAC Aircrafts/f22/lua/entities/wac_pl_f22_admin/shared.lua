...
ENT.PrintName			= "[WAC]F-22A Raptor (Admin)"
...
ENT.Seats = {
	{
		...
		weapons={"M61A2 Vulcan", "AIM-9M/X", "AIM-120C","JDAM GBU-38"}
	}
}
...
function ENT:DrawPilotHud()
	...
	if self:GetNWInt("seat_1_actwep") == 3 and self.weapons["AIM-120C"] then
		surface.SetTextPos(300,445)
		local n = self.weapons["AIM-120C"]:GetAmmo()
		surface.DrawText("AIM-120C" .. getspaces(n))
	end
	if self:GetNWInt("seat_1_actwep") == 4 and self.weapons["JDAM GBU-38"] then
		surface.SetTextPos(300,445)

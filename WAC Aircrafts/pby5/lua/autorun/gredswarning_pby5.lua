...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(1108898771) and steamworks.IsSubscribed(1108898771)
		...
		if !RequiredContent then
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=1108898771.html')
		end
	end
end)
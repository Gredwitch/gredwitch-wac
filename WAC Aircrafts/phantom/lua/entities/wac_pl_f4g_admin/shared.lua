...
ENT.PrintName			= "[WAC]F-4 Phantom II (Admin)"
...
ENT.Seats = {
	{
		...
		weapons={"GAU-4 M61 Vulcan", "Bombs", "Mark 77 Napalm", "AIM-7 Missiles", "Hydra 70 Missiles"},
	},
	{
		pos=Vector(123, 0, 85),
		exit=Vector(123,100,40),
		weapons={"Bombs", "Mark 77 Napalm", "AIM-7 Missiles"}
	},
}

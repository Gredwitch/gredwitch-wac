...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(141486806) and steamworks.IsSubscribed(141486806)
		...
		if !RequiredContent then
			...
			GredWACCFrame:SetTitle("WAC Community 6 is not installed / enabled. To disable this, open the spawnmenu, open the top right 'Options' tab, click on 'Misc' under the 'Gredwitch's Stuff' subtab and untick the 'Enable pop ups about missing content' checkbox.")
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=141486806.html')
		end
	end
end)
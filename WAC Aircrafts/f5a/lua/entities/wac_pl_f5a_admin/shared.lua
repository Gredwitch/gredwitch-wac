...
ENT.PrintName			= "[WAC]F-5A Freedom Tiger (Admin)"
ENT.Author				= "Gredwitch"
ENT.Spawnable			= true
ENT.AdminSpawnable		= true
ENT.Model	    = "models/gredwitch/f5a/f5a.mdl"
...
ENT.Wheels={
	{
		mdl="models/gredwitch/f5a/f5a_wb.mdl",
		pos=Vector(-93.73,53.87,11.87),
		friction=10,
		mass=600,
	},
	{
	...
	{
		mdl="models/gredwitch/f5a/f5a_wf.mdl",
		pos=Vector(120.27,0,8.94),
		friction=10,
		mass=1200,
	},
}
...
ENT.Seats = {
	{
		pos=Vector(63.69,0,54),
		exit=Vector(100,100,70),
		weapons={"M39A2", "Mk 82", "Mk 77", "AIM-9", "AGM-65 Maverick", "Hydra 70"}
	}
}
...
ENT.Weapons = {
	["M39A2"] = {
		...
		info = {
			...
			Sounds = {
				shoot = "wac/f5a/shoot_start.wav",
				stop = "wac/f5a/shoot_end.wav"
			},
		}
	},
	["Mk 82"] = {
	...
	["Hydra 70"] = {
		...
		info = {
			Pods = {
				Vector(-87.47,-111.25,41.78),
			},
			Sequential = true,
			Kind = "gb_rocket_hydra",
			Ammo = 1,
			FireRate = 200,
			TkAmmo = 0
		}
...
ENT.Sounds={
	Start="WAC/f5a/Start.wav",
	Blades="WAC/f5a/external.wav",
	Engine="WAC/f5a/internal.wav",

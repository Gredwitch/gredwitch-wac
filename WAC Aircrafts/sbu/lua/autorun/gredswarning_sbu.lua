...
timer.Simple(5,function()
	if CLIENT then
		...
		RequiredContent=steamworks.ShouldMountAddon(336969336) and steamworks.IsSubscribed(336969336)
		...
		if !RequiredContent then
			...
			h:SetSize(x*0.99,y*0.96)
			h:SetAllowLua(true)
			h:OpenURL('https://steamcommunity.com/workshop/filedetails/?id=336969336.html')
		end
	end
end)
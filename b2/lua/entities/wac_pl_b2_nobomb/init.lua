...
function ENT:PhysicsUpdate(ph)
	...
	local trace=util.QuickTrace(self:LocalToWorld(Vector(0,0,62)), self:LocalToWorld(Vector(0,0,50)), {self, self.wheels[1], self.wheels[2], self.wheels[3],  self.wheels[4], self.wheels[5], self.wheels[6], self.wheels[7], self.wheels[8], self.wheels[9], self.rotor})
